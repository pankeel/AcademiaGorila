...
public class Config {
    ...
    public static String URL_HOST = "https://agro.gorila.com.py";
    public static int HEADLINE_CATEGORY_ID = 17; // Your Categories -> www.YOUR_WORDPRESS_SITE/wp-json/wp/v2/categories;
    public static int CATEGORY_FILTER = 3;
    ...
    public static String URL_CATEGORIES = URL_HOST + "/wp-json/wp/v2/categories?per_page=100";
    ...
    public static int PARENT_CATEGORY_FILTER = 0;
